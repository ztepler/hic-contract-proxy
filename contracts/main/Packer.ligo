...
| Pack_create_english_auction of placeEnglishParams
...
function create_english_auction(var params : placeEnglishParams) : bytes is Bytes.pack(params)
...
| Pack_create_english_auction(p) -> ((nil: list(operation)), create_english_auction(p))
end
